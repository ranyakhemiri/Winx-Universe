				...
				public void actionPerformed(ActionEvent e) {
						for (int y=0;y<64;y++) {
							if (Jcase[y].isSelected()) {
								//enregistrement du personnage selectionné:
								setCase_selectionee(Jcase[y]);
								//affichage du personnage selectionné et sa position sur la console:
								System.out.println("Personnage selectionné: "+ Jcase[y].getOccupant().getNom()
